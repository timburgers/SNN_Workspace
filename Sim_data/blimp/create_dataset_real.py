...
original_folder = "/home/tim/SNN_Workspace/Sim_data/blimp/down_pd_i/"
...
for file in original_files:
    ...
    for step_ind in rows_with_change:
        if step_ind-start_before_step*freq >= 0 and step_ind+(time_sim-start_before_step)*freq < total_rows:
            ...
            df_individual_step['u_i'] = df_individual_step["u_i"] - df_individual_step["u_i"].iloc[0]

            # Set the first timestep of the d to zero
            df_individual_step['u_d'].iloc[0] = 0
            df_individual_step['u_pd'].iloc[0] = df_individual_step['u_p'].iloc[0]
