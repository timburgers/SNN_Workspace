...
all_files =["PID_with_I","IWTA-LIF"]
colors_files = ["tab:blue","tab:orange"]
labels = ["PID","PD + IWTA","Target"]
color_ref = "tab:red"
opacity = 0.4
start = 140
stop_seconds= 160
...
ax2,ax3 = plt.subplot(gs[1],sharex = ax0), plt.subplot(gs[2],sharex = ax0)
ax_list = [ax0,ax2,ax3] 
...
plt.savefig("/home/tim/Documents/plots_papers/controller_B_IWTA.pdf")
# plt.show()