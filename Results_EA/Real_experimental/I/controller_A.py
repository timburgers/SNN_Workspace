...
ax3.set_ylim([-0.4,3.3])

ax0.legend(lines,labels,loc='lower right', frameon=True, shadow=True,ncols=3)
...
plt.savefig("/home/tim/Documents/plots_papers/controller_A.pdf")
# plt.show()