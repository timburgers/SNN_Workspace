...
all_files =["IWTA-LIF","R-LIF","R-IWTA-LIF"]
colors_files = ["tab:blue","tab:orange","tab:grey"]
labels = ["PD + IWTA-LIF","PD + R-LIF" ,"PD + R-IWTA-LIF","Target"]
color_ref = "tab:red"
opacity = 0.4
stop_seconds= 140
...
for file_name in all_files:
    ...
    if include_average_line:
        ...
        ax.plot(time,row_avg, color = colors_files[ind],linewidth =8,alpha=1,zorder=100)
...
plt.savefig("/home/tim/Documents/plots_papers/Blimp_I.pdf")
# plt.show()